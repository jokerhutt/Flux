// Auto-generated by cft from: LLJIT.h
...
cdecl{}* LLVMOrcLLJITBuilderObjectLinkingLayerCreatorFunction(void* Ctx, LLVMOrcOpaqueExecutionSession* ES, byte* Triple) -> LLVMOrcOpaqueObjectLayer*;
...
LLVMOrcOpaqueLLJITBuilder* as LLVMOrcLLJITBuilderRef;
...
LLVMOrcOpaqueLLJIT* as LLVMOrcLLJITRef;
...
cdecl LLVMOrcCreateLLJITBuilder() -> LLVMOrcOpaqueLLJITBuilder*;
///
*
...
cdecl LLVMOrcDisposeLLJITBuilder(LLVMOrcOpaqueLLJITBuilder* Builder) -> void;
///
*
...
cdecl LLVMOrcLLJITBuilderSetJITTargetMachineBuilder(LLVMOrcOpaqueLLJITBuilder* Builder, LLVMOrcOpaqueJITTargetMachineBuilder* JTMB) -> void;
///
*
...
cdecl LLVMOrcLLJITBuilderSetObjectLinkingLayerCreator(LLVMOrcOpaqueLLJITBuilder* Builder, def{}*(void*, LLVMOrcOpaqueExecutionSession*, byte*) -> LLVMOrcOpaqueObjectLayer* F, void* Ctx) -> void;
///
*
...
cdecl LLVMOrcCreateLLJIT(LLVMOrcOpaqueLLJIT** Result, LLVMOrcOpaqueLLJITBuilder* Builder) -> LLVMOpaqueError*;
///
*
...
cdecl LLVMOrcDisposeLLJIT(LLVMOrcOpaqueLLJIT* J) -> LLVMOpaqueError*;
///
*
...
cdecl LLVMOrcLLJITGetExecutionSession(LLVMOrcOpaqueLLJIT* J) -> LLVMOrcOpaqueExecutionSession*;
///
*
...
cdecl LLVMOrcLLJITGetMainJITDylib(LLVMOrcOpaqueLLJIT* J) -> LLVMOrcOpaqueJITDylib*;
///
*
...
cdecl LLVMOrcLLJITGetTripleString(LLVMOrcOpaqueLLJIT* J) -> byte*;
///
*
...
cdecl LLVMOrcLLJITGetGlobalPrefix(LLVMOrcOpaqueLLJIT* J) -> byte;
///
*
...
cdecl LLVMOrcLLJITMangleAndIntern(LLVMOrcOpaqueLLJIT* J, byte* UnmangledName) -> LLVMOrcOpaqueSymbolStringPoolEntry*;
///
*
...
cdecl LLVMOrcLLJITAddObjectFile(LLVMOrcOpaqueLLJIT* J, LLVMOrcOpaqueJITDylib* JD, LLVMOpaqueMemoryBuffer* ObjBuffer) -> LLVMOpaqueError*;
///
*
...
cdecl LLVMOrcLLJITAddObjectFileWithRT(LLVMOrcOpaqueLLJIT* J, LLVMOrcOpaqueResourceTracker* RT, LLVMOpaqueMemoryBuffer* ObjBuffer) -> LLVMOpaqueError*;
///
*
...
cdecl LLVMOrcLLJITAddLLVMIRModule(LLVMOrcOpaqueLLJIT* J, LLVMOrcOpaqueJITDylib* JD, LLVMOrcOpaqueThreadSafeModule* TSM) -> LLVMOpaqueError*;
///
*
...
cdecl LLVMOrcLLJITAddLLVMIRModuleWithRT(LLVMOrcOpaqueLLJIT* J, LLVMOrcOpaqueResourceTracker* JD, LLVMOrcOpaqueThreadSafeModule* TSM) -> LLVMOpaqueError*;
///
*
...
cdecl LLVMOrcLLJITLookup(LLVMOrcOpaqueLLJIT* J, ulong* Result, byte* Name) -> LLVMOpaqueError*;
///
*
...
cdecl LLVMOrcLLJITGetObjLinkingLayer(LLVMOrcOpaqueLLJIT* J) -> LLVMOrcOpaqueObjectLayer*;
///
*
* Returns a non-owning reference to the LLJIT instance's object linking layer.
...
cdecl LLVMOrcLLJITGetObjTransformLayer(LLVMOrcOpaqueLLJIT* J) -> LLVMOrcOpaqueObjectTransformLayer*;
///
*
...
cdecl LLVMOrcLLJITGetIRTransformLayer(LLVMOrcOpaqueLLJIT* J) -> LLVMOrcOpaqueIRTransformLayer*;
///
*
...
cdecl LLVMOrcLLJITGetDataLayoutStr(LLVMOrcOpaqueLLJIT* J) -> byte*;
///
*
* @}
